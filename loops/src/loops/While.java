...
public class While {
	...
	public static void main(String[] args) {
		...
		/*Crear un programa que solicite el usuario un numero. Dicho numero sera tomado como el
		 * numero final de una cuenta. Diccha cuanta inicia en 1. Debe mostrar en consola la cuenta del 1 hasta
		 ...
		 * 4.Guadar en variable el numero que iniciar la cuenta (1)
