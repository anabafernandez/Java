...
//Se modifico la variable a  getElementById
const divProductos = document.getElementById("lista-de-productos"); //cambiamos el nombre de variable a divProductos
const inputFiltro = document.getElementById("filtro"); //cambiamos el nombre de variable a inputFiltro
